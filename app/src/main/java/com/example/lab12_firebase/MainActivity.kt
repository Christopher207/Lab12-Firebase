                ...
                for (dc in snapshots!!.documentChanges){
                    when(dc.type){
                        DocumentChange.Type.ADDED->{
                            ...
                            Snackbar.make(findViewById(android.R.id.content),"Se agregó",Snackbar.LENGTH_LONG).show()
                        }
                        DocumentChange.Type.MODIFIED -> {
                            tvCurso.text = dc.document.data["description"].toString()
                            tvNota.text = dc.document.data["score"].toString()
                            Snackbar.make(findViewById(android.R.id.content),"Se modificó",Snackbar.LENGTH_LONG).show()
                        }
